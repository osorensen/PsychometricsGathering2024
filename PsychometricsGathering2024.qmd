...
![](figures/star_3.jpg){fig-align="center"}
:::
...
[@asparouhovDynamicStructuralEquation2018;@mcneishPrimerTwolevelDynamic2020]

## Intense longitudinal data

- Hamiltonian Monte Carlo (`Stan`) seems to be the most practical computational option (or Gibbs sampling in MPlus)
